...
Mutations and subscriptions work similarly—you define fields on the `Mutation` and `Subscription` types, and those are available as the root `mutation` and `subscription` fields you can call in your request.
